...
def scatter2Sat2(ulx,uly,lrx,lry,z_buffer,pas_de_temps,datedeb, datefin,
                 type1,sat1,prd_sat1,res_sat1,variable_sat1,level_sat1, 
                 type2,sat2,prd_sat2,res_sat2,variable_sat2,level_sat2,
                 ):
    ...
    a1, b1, r_value, p_value, std_err = linregress(mat1[mask], mat2[mask])
    line_sat = a1 * mat1[mask] + b1
...
#####################################################################################
    ...
    satellite = scatter2Sat(ulx,uly,lrx,lry,z_buffer, pas_de_temps,datedebut, datefin,type1,sat1,prd_sat1,res_sat1,variable_sat1,level_sat1,type2,sat2,prd_sat2,res_sat2,variable_sat2,level_sat2)
    
    satellite1 = scatter2Sat2(ulx,uly,lrx,lry,z_buffer, pas_de_temps,datedebut, datedebut,type1,sat1,prd_sat1,res_sat1,variable_sat1,level_sat1,type2,sat2,prd_sat2,res_sat2,variable_sat2,level_sat2)
